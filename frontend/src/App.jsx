    ...
    <>
      <main className="site-shell">
        <header className="hero" id="inicio">
          <img className="hero-logo" src="/logo-don-benito.png" alt="Clinica Dental Don Benito" />
        ...
        <section className="reviews" id="resenas">
          <div className="section-head">
            ...
            <p>Mostradas desde Google Places API con cache en backend para mejor rendimiento.</p>
          </div>
          <ReviewsSlider />
        </section>
